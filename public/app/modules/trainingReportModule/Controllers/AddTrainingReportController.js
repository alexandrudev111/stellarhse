(function () {
    var controller = function ($scope, $uibModal, coreReportService, coreService, $state, $q, trainingReportService, $filter, $controller) {
        ...
        $scope.onTrainingProviderSelected = function (selectedItem) {
            ...
            console.log($scope.report.report_third_party);
        };
...
//                $scope.trainingReasons = queues[1].data;
...
//                selectedItem.contractorRemove = true;
            console.log('onThirdPartySelected',selectedItem);
...
//        get  what Training Custom fields
...
//        };
    ...
    controller.$inject = ['$scope', '$uibModal', 'coreReportService', 'coreService', '$state', '$q', 'trainingReportService', '$filter', '$controller'];
    angular.module("trainingReportModule").controller("AddTrainingReportController", controller);
}());
